...
define([
  ...
  __uri('./daterangepicker.js')] ,
	function($ , moment , urlhand , daterangepicker){
  var DatePicker = function( dateStart = moment().format("YYYY-MM-DD"), dateEnd = moment().format("YYYY-MM-DD") , paramsObj , dom = "#reportrange"){
